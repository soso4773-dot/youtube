...
**대본 작성 형식 규칙 (반드시 지켜주세요):**
- 캐릭터 이름이나 화자 표시를 절대 사용하지 마세요 (예: "주하:", "나레이션:", "MC:" 등)
- 마크다운 서식을 사용하지 마세요 (**, *, #, - 등)
- 괄호나 대괄호로 지문을 넣지 마세요 (예: [웃으며], (손을 흔들며) 등)
- 순수하게 말할 내용만 작성하세요
- 각 문단은 자연스럽게 이어지도록 작성하세요
- 마치 한 사람이 카메라 앞에서 말하는 것처럼 작성하세요
